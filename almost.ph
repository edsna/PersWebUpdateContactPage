				...
				<div class="EmailForm">
					...
					<p class = ""> 
                        <ul class = ""style="display: inline;">
                            ...
                            <li style="display: inline;" id="um">8</li>
                            <li style="display: inline;" id="dois">6</li>
                            <li style="display: inline;" id="tres">0</li>
                            <li style="display: inline;" id="quatro">&#41;</li>
                            <li style="display: inline;" id="cinco">2</li>
                            <li style="display: inline;" id="seis">8</li>
                            <li style="display: inline;" id="sete">0</li>
                            <li style="display: inline;" id="oito">&#45;</li>
                            <li style="display: inline;" id="nove">6</li>
                            <li style="display: inline;" id="dez">3</li>
                            <li style="display: inline;" id="onze">8</li>
                            <li style="display: inline;" id="doze">0</li>
    ...
    <div class="col" id="col2">
            <div class="card card-block">
                <div class="MoreDetails">
                    ...
                    <h2 class = "hide">Contact Details</h2>
                    ...
                    <p class = "hide"> <strong>Fax:</strong> 
                        <ul class = "hide">
                            <li id="dois">&#43;</li>
                            <li id="tres">1</li>
                            <li id="zero">&#40;</li>
                    ...
                    <p1>
						 <a class = "hide" target="_blank" title="LinkedIn" href="http://www.linkedin.com/in/edsonzandamela/" style="color: blue; text-decoration: underline;"> LinkedIn</a>
					</p1>
                        
                    <p1>
						 <a class = "hide" target="_blank" title="GitHub" href="http://github.com/edsna" style="color: blue; text-decoration: underline;"> GitHub</a>
					</p1>
